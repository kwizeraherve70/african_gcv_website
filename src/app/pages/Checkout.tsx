          ...
          <div className="flex gap-3 mt-8">
            {currentStep !== 'shipping' && (
              <button
                ...
                className="flex-1 py-3.5 px-6 border border-border rounded-xl hover:bg-accent text-sm font-medium transition-colors"
              >
                Back
              </button>
            )}
            <button
              type="submit"
              className="flex-1 py-3.5 px-6 bg-brand-purple text-white rounded-xl hover:bg-brand-purple-light text-sm font-semibold transition-all duration-200 shadow-lg shadow-brand-purple/20 hover:-translate-y-0.5"
            >
